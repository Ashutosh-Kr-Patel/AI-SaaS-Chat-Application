...
const Chat = () => {
  ...
  const handleDeleteChats = async () => {
    try {
      ...
      setChatMessages([]);
      toast.success("Deleting Chat Successfully", { id: "deletechats"});
    } catch (error) {
      console.log(error);
        ...
        >
          <Avatar sx={{
            ...
            <Typography sx={{ mx: "auto",fontFamily: "work sans", my:4, p:3 }}>
              You can ask some questions related to Knowledge, Bussiness, Advices, Education, programmimg, etc.
              But avoid sharing personal informatoion.
            </Typography>
            <Button 
